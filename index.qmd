...
A pesquisa foi realizada com o auxílio de algumas ferramentas, como o Parsifal [@misc], que é um sistema online de apoio à revisão sistemática da literatura utilizando o método PRISMA (Preferred Reporting Items for Systematic reviews and Meta-Analyses) que é uma metodologia criada para direcionar o desenvolvimento de revisões sistemáticas da literatura [@page2021]. A figura 1 apresenta o fluxograma do processo que foi seguido para a realização do trabalho.
